...
export class NativeBattle {
 ...
 enemyAttackDamage(enemy,scale=1){return enemy.atk*scale*enemyConditionalAttackMultiplier(enemy)*(enemy.waterAttackMultiplier??1)*(1+Math.min(0,statusAttributeChanges(enemy).attack||0));}
 ...
 stats(u){
  ...
  if(u.kind==='summon')return {...u,atk:u.atk*(1+(u.sandAttackRatio||0))*mouseSandScale,magicResistance:u.res||0,tauntLevel:0,parts:[]};
