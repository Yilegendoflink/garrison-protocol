...
import {ensureBattleShape,migrateBattle,validateBattle,dealDamage,applyHeal,applyRegen,applyLoss,commitExit,tickLogic,effectStatMods,dispatch,newAttackId,attackableAllies,getActor,blockingActors,alliedActors} from './native-effects.js';

export class NativeBattle {
 constructor(data,economy,map,turn,{restore=false}={}){
  this.data=data;this.economy=economy;this.map=map;this.turn=turn;
 ...
 stats(u){
  ...
  const extra=effectStatMods(this,u);atk+=extra.ratio.atk||0;hp+=extra.ratio.maxHp||0;def+=extra.ratio.def||0;as+=extra.attackSpeed;base.magicResistance+=extra.magicResistance;base.spRecoveryPerSec+=extra.spRecoveryPerSec;parts.push(...extra.parts);
