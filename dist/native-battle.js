...
export class NativeBattle {
 ...
 prepareWaves(turn){const plan=nativeWavePlan(this.data,turn);this.level=plan.level;this.s.queue=plan.queue;this.s.total=plan.total;}
 path(route,flying){
