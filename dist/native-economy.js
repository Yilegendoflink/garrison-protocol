...
export class NativeEconomy extends PreparationState {
 constructor(data,modeId,options={}){
  ...
  Object.assign(this.s,{bondLayers:{},claimedBondRewards:{},strategyClaims:{},roundBoughtBonds:{},carryFunds:0,forcedRefresh:null,permanentDiscount:0,nextRoundBonus:0,freeRefresh:0,roundGainCount:0,roundSpent:0,roundRefreshCount:0,refreshCountTotal:0,totalSpent:0,rewardQueue:[],randomState:(options.seed??1)>>>0,bandId:options.bandId??null,lastPrepRound:null,playerId:options.playerId??'local',teamPeers:structuredClone(options.teamPeers||[]),transferInbox:[],transferOutbox:[]});if(this.s.bandId)this.s.hp=this.s.maxHp=data.season.bandDataListDict[this.s.bandId].totalHp;
 }
 command(type,...args){
