...
const effects={
 ...
 give_coin_in_round:{event:'prep',run:(c,p)=>{if(c.s.round===p.round)c.addFunds(p.coin-baseFunding(c.s.round));}},// 把该回合整备资金顶到 p.coin：基数走 baseFunding（含 11 上限），不要再写 round+3
